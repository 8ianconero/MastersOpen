...
table20.innerHTML +=
`
<tr><td>${quique.nombre}</td><td>${quique.victorias}</td><td>${quique.derrotas}</td><td>${quique.puntosFavor}</td><td>${quique.puntosContra}</td><td>${quique.puntosTotales}</td></tr>

<tr><td>${javicho.nombre}</td><td>${javicho.victorias}</td><td>${javicho.derrotas}</td><td>${javicho.puntosFavor}</td><td>${javicho.puntosContra}</td><td>${javicho.puntosTotales}</td></tr>

<tr><td>${paco.nombre}</td><td>${paco.victorias}</td><td>${paco.derrotas}</td><td>${paco.puntosFavor}</td><td>${paco.puntosContra}</td><td>${paco.puntosTotales}</td></tr>

<tr><td>${bianconero.nombre}</td><td>${bianconero.victorias}</td><td>${bianconero.derrotas}</td><td>${bianconero.puntosFavor}</td><td>${bianconero.puntosContra}</td><td>${bianconero.puntosTotales}</td></tr>

<tr><td>${raton.nombre}</td><td>${raton.victorias}</td><td>${raton.derrotas}</td><td>${raton.puntosFavor}</td><td>${raton.puntosContra}</td><td>${raton.puntosTotales}</td></tr>
`;
